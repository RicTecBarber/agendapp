                      ...
                      {availabilities.map((availability: any) => (
                        <TableRow key={availability.id}>
                          ...
                          <TableCell>
                            ...
                            {/* Removido exibição de horário de almoço - campos não existem no banco */}
                          </TableCell>
                          <TableCell>
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4 py-4">
            <div className="grid gap-4">
              ...
              {/* Seção de horário de almoço removida - campos não existem no banco de dados */}
            </div>
          </div>
            ...
            <div className="py-4">
              <div className="rounded-md bg-muted p-4">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {/* Exibição de horário de almoço removida - campos não existem no banco de dados */}
                </div>
              </div>
            </div>
          )}
